...
export const EMPREENDIMENTOS = [
  ...
  {
    slug: "beira-mar-fortaleza",
    nome: "Beira-Mar Residence",
    pais: "brasil",
    cidade: "Fortaleza",
    zona: "Nordeste",
    tipo: "Apartamento",
    ...
    destaque: true,
    resumo:
      "T3 frente-mar em Fortaleza, com yields elevadas e preço de entrada competitivo no Nordeste.",
    descricao:
      "Na orla de Fortaleza, este empreendimento frente-mar oferece a combinação rara de preço de entrada competitivo e rentabilidades de arrendamento acima da média. O Nordeste brasileiro é a região de maior crescimento turístico do país — uma oportunidade de elevada yield para o investidor português.",
    caracteristicas: [
      "Frente-mar (Beira-Mar)",
      "Yields elevadas",
      "Preço de entrada competitivo",
      "Lazer completo",
      "Forte procura turística",
    ],
    imagens: [u("1600596542815-ffad4c1539a9"), u("1560448204-e02f11c3d0e2"), u("1600607687939-ce8a6c25118c")],
  },
  {
